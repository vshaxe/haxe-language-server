...
class PositionHelper {
     ...
     */
    public static function isBefore(pos:Position, other:Position):Bool {
     ...
     */
    public static function isBeforeOrEqual(pos:Position, other:Position):Bool {
        if (pos.line < other.line) {
            return true;
        }
        if (other.line < pos.line) {
     ...
     */
    public static function isAfter(pos:Position, other:Position):Bool {
     ...
     */
    public static function isAfterOrEqual(pos:Position, other:Position):Bool {
     ...
     */
    public static function isEqual(pos:Position, other:Position):Bool {
     ...
     */
    public static function compareTo(pos:Position, other:Position):Int {
        if (pos.line < other.line) {
            return -1;
     ...
     */
    public static inline function translate(pos:Position, lineDelta:Int, characterDelta:Int):Position {
     ...
     */
    public static inline function translatePos(pos:Position, other:Position):Position {
     ...
     */
    public static inline function with(pos:Position, ?line:Int, ?character:Int):Position {
        var line = if (line == null) pos.line else line;
        var character = if (line == null) pos.character else character;
        return { line: line, character: character };
    }

    public static inline function toRange(pos:Position):Range {
