...
class VshaxeMethods {
    ...
    **/
    static inline var DidChangeDisplayArguments = new NotificationMethod<{arguments:Array<String>},NoData>("vshaxe/didChangeDisplayArguments");

    /**
        This notification is sent from the client to the server when display arguments have changed.
    **/
    static inline var DidChangeDisplayServerConfig = new NotificationMethod<DisplayServerConfig,NoData>("vshaxe/didChangeDisplayServerConfig");
    ...
    **/
    static inline var DeterminePackage = new RequestMethod<{fsPath:String},{pack:String},NoData,NoData>("vshaxe/determinePackage");
    ...
    **/
    static inline var UpdateParseTree = new NotificationMethod<{uri:String, parseTree:String},NoData>("vshaxe/updateParseTree");
    ...
    **/
    static inline var ProgressStart = new NotificationMethod<{id:Int, title:String},NoData>("vshaxe/progressStart");
    ...
    **/
    static inline var ProgressStop = new NotificationMethod<{id:Int},NoData>("vshaxe/progressStop");

    /**
        This notification is sent from the server to the client when the display port has changed.
    **/
    static inline var DidChangeDisplayPort = new NotificationMethod<{port:Int},NoData>("vshaxe/didChangeDisplayPort");
}
